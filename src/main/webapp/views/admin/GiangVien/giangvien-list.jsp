						...
						<div class="card-body">
							<div class="table-responsive">
								<div class="text-right my-2">
									<a href="AddTeacher" class="btn btn-primary btn-icon-split">
										<span class="icon text-white-50"> <i
											class="fas fa-plus"></i>
									</span> <span class="text">Thêm Giảng viên</span>
									</a>
								</div>
								<table class="table table-bordered" id="dataTable" width="100%"
									...
									<c:forEach items="${gvList}" var="gv" varStatus="STT">
										<tr class="odd gradeX">
											<td><a
												href="<c:url value='/detailTeacher?id=${gv.id}'/>">${gv.id}</a></td>
											<td>${gv.hoten}</td>
											<td><c:choose>
											...
											<td>
												<button class="btn btn-primary " type="button">
													<a href="<c:url value='/editTeacher?id=${gv.id}'/>"
														style="color: white">Sửa</a>
												</button>
												<button class="btn btn-danger " type="button">
													<a href="<c:url value='/DeleteTeacher?id=${gv.id}'/>"
														onclick="return confirm('Are you sure you want to delete teacher ${sv.id}?')"
