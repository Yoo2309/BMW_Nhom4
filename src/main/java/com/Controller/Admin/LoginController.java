...
public class LoginController extends HttpServlet {
	...
	public static final String ERROR2 = "Invalid2";
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			if ((csrfToken != null) && (csrfToken.equals(storedToken)))
			{
				...
				//System.out.println("D: "+csrfToken);
				req.getSession().setAttribute("csrfToken", csrfToken);
    			//System.out.println("E: "+req.getSession().getAttribute("csrfToken"));
			}	else url = ERROR2;	
