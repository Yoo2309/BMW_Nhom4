...
INSERT [dbo].[DeTai] ([ma_detai], [ten_detai], [ma_chuyennganh], [gvhd], [gvpb], [trangthai], [nam_totnghiep], [soluongsinhviendangky]) VALUES (5, N'Dự án dự báo thời tiết', 1, N'chaultm', NULL, 0, 2022, 0)
...
CREATE TABLE [dbo].[SinhVien](
	...
	[khoa] [int] NOT NULL REFERENCES [dbo].[KhoaHoc](ma_khoahoc),
...
CREATE TABLE [dbo].[Accounts](
	[username] VARCHAR(50) PRIMARY KEY REFERENCES Peoples(email),
